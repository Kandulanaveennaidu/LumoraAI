    ...
    columns: [
      ...
      },
      {
        ...
        links: [
          ...
          { label: 'Invideo VS LumoraAI', href: '#' },
          { label: 'Synthesia VS LumoraAI', href: '#' },
          { label: 'Loom VS LumoraAI', href: '#' },
          { label: 'Sora VS LumoraAI', href: '#' },
          { label: 'HeyGen VS LumoraAI Video Dubbing', href: '#' },
          { label: 'HeyGen VS LumoraAI Video Generator', href: '#' },
          { label: 'Colossyan VS LumoraAI Avatars', href: '#' },
          { label: 'Colossyan VS LumoraAI Video Generator', href: '#' },
          { label: 'Pipio VS LumoraAI', href: '#' },
        ],
      },
    ],
  },
    ...
    columns: [
      ...
      },
      {
        ...
        links: [
          ...
          { label: 'How to Make AI Avatars using Sora x LumoraAI', href: '#' },
    ...
    <footer className="bg-neutral-900 text-neutral-300">
      <div className="container mx-auto px-4 md:px-6 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div className="lg:col-span-1 space-y-6">
            <Link href="/" className="flex items-center gap-2 mb-3">
              ...
              <span className="text-2xl font-bold text-white">LumoraAI</span>
            </Link>
            <p className="text-sm">
              LumoraAI&apos;s video generator and conversational AI technology aim to bridge the gap between the advantages of human interaction and digital convenience.
            </p>
            <p className="text-sm">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="outline"
                  className="w-full justify-between text-neutral-300 border-neutral-600 bg-black hover:bg-neutral-800 hover:text-white"
                >
              ...
              <DropdownMenuContent className="bg-black border-neutral-700 text-neutral-300 w-[--radix-dropdown-menu-trigger-width]">
                <DropdownMenuItem className="hover:bg-neutral-800 focus:bg-neutral-800">English</DropdownMenuItem>
                <DropdownMenuItem className="hover:bg-neutral-800 focus:bg-neutral-800">Español</DropdownMenuItem>
                <DropdownMenuItem className="hover:bg-neutral-800 focus:bg-neutral-800">Français</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-xs text-neutral-500">
          ...
          <p>Copyright © {new Date().getFullYear()} LumoraAI. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );

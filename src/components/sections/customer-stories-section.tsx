...
const testimonialsData: Testimonial[] = [
  {
    ...
    quote:
      'It used to take me four different programs and 2 to 3 hours to create one video, but now I can do it within half an hour with LumoraAI. That has been a game changer for me - the time saving and ease of use are incredible.',
  ...
  },
  {
    ...
    logoHeight: 30,
    quote:
      "LumoraAI's focus on creating realistic AI avatars enable businesses to automate and enhance customer interactions and increase operational efficiency.",
  ...
  },
  {
    ...
    logoHeight: 35,
    quote:
      'Lenovo is partnering with LumoraAI to use their AI Human with powerful large language models (LLMs) to deliver a 24/7 automated concierge service in hospitality and retail settings.',
    companyName: 'Lenovo',
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-10 md:mb-12">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-3">
            LumoraAI Makes Video Creation <span className="text-primary">Better for Everyone</span>
          </h2>

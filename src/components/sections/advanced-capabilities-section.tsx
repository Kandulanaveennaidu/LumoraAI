      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-10 md:mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
            LumoraAI offers more than just video creation. With real-time
            conversational avatars and deepfake detection, it&apos;s a full
            suite of AI tools designed to meet all your needs.
          </p>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 p-6 md:p-10 text-center md:text-left">
              ...
              <p className="text-muted-foreground mb-3">
                Create realistic, interactive AI experiences that feel like
                genuine conversations. Our AI Humans are designed to listen,
                respond, and deliver an authentic conversational experience.
              </p>
              <p className="text-muted-foreground mb-6">
                Chat naturally in over 80 languages and easily connect with your
                existing systems, including AI agent systems and large language
                models like ChatGPT.
              </p>
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          ...
          <div className="md:w-1/2 text-center md:text-left">
            ...
            <p className="text-muted-foreground mb-6">
              Be the first to know when deepfakes surface, with instant,
            ...
            <div className="space-y-4 mb-8">
              <div className="p-4 border border-border rounded-lg bg-background hover:shadow-md transition-shadow">
                <p className="text-sm text-foreground">
                  Select an individual for round-the-clock monitoring against
                  deepfake appearances across the web.
                </p>
              </div>
              <div className="p-4 border border-border rounded-lg bg-background hover:shadow-md transition-shadow">
                <p className="text-sm text-foreground">
                  Receive immediate notifications when deepfakes of protected
                  individuals are detected, along with regular data reports to
                  track impact & trends.
                </p>
              </div>
            </div>

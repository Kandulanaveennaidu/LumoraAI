...
const newsData: NewsArticle[] = [
  ...
  {
    id: 'news-2',
    title: 'Is LumoraAI the Best YouTube Video Downloader?',
    description: 'Discover why you should consider LumoraAI for downloading videos - a top choice for efficient media management.',
  ...
  },
  {
    ...
    description: 'The AI agent market is poised for rapid growth by 2025. Explore how LumoraAI is at the forefront of this technological shift.',
  ...
  },
  {
    ...
    description: "LumoraAI's Affiliate Program provides you with the opportunity to earn reliable revenue by promoting cutting-edge AI video tools.",
  ...
  },
  {
    ...
    description: 'Discover the best AI dubbing tools, like those integrated into LumoraAI, to effortlessly localize your video content for a global audience.',
  ...
  },
  {
    ...
    description: 'See how LumoraAI is helping transform the landscape of news broadcasting with advanced AI-powered video solutions.',
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 md:mb-10">
          <div className="flex-grow text-center md:text-left mb-4 md:mb-0">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-foreground">
              Discover <span className="text-primary">LumoraAI</span> News and Updates
            </h2>
          </div>

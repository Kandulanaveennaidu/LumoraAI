...
const capabilities: AiCapability[] = [
  ...
  },
  {
    ...
    imageAlt: 'AI generated art of a fluffy cat in a snowy field',
    aiHint: 'cat snow',
    imageWidth: 600,
    imageHeight: 400,
  },
  {
    ...
    imageAlt: 'AI video production interface with futuristic avatar',
    aiHint: 'futuristic avatar',
    imageWidth: 600,
    imageHeight: 400,
  },
];
            ...
            >
              <div className="aspect-video relative w-full">
                <Image
                  ...
                  fill
                  className="object-contain p-2" // object-contain to show full image if aspect ratio differs

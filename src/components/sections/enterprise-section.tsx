...
import { Users, Zap, Infinity as InfinityIcon, Users2, Server } from 'lucide-react'; // Users2 for team icons, Server for API
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="text-center mb-10 md:mb-12">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-3">
            LumoraAI <span className="text-primary">Enterprise</span>
          </h2>
          ...
          <Card className="rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300 bg-card">
            <CardContent className="p-6">
              ...
              <div className="aspect-video relative rounded-lg overflow-hidden">
                <Image
                  src="https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?q=80&w=400&h=225&auto=format&fit=crop"
                  alt="Professional studio avatar creation"
                  fill
                  className="object-cover"
                  data-ai-hint="video creation professional"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {[
            ...
            },
            {
              ...
              description: 'Enjoy personalized support whenever you need it, plus a dedicated customer success manager to help you make the most of LumoraAI.',
              aiHint: 'support team person'
            },
            {
              Icon: ApiAccessIcon,
              title: 'API Access',
              description: 'Integrate LumoraAI via our API to enhance your workflow or services. Automate video production, optimize tasks, and expand your content capabilities.',
